...
function fetchCountries(name) {
  return fetch("https://restcountries.com/v3.1/name/".concat(name, "?fields=name,capital,population,flags,languages")).then(function (response) {
    if (!response.ok) {
...
var listEl = document.querySelector(".country-list");
var divEl = document.querySelector(".country-info");
inputEl.addEventListener("input", (0, _lodash.default)(onInputChange, DEBOUNCE_DELAY));

function onInputChange(e) {
  outputClear();

  if (e.target.value.trim() != "") {
    (0, _fetchCountries.fetchCountries)(e.target.value.trim()).then(renderHTML).catch(function (error) {
...
function renderCountriesList(countriesArr) {
  var markup = countriesArr.map(function (_ref) {
    var flags = _ref.flags,
        name = _ref.name;
    return "<li class=\"country-item\">\n        <img class=\"country-flag\" src=\"".concat(flags.svg, "\" width=\"50px\">\n        <p class=\"country-text\">").concat(name.official, "</p>\n        </li>");
  }).join("");
  listEl.insertAdjacentHTML("beforeend", markup);
}

function renderCountryCard(country) {
  var markup = country.map(function (_ref2) {
    var flags = _ref2.flags,
        name = _ref2.name,
        capital = _ref2.capital,
        population = _ref2.population,
        languages = _ref2.languages;
    return "<div class=\"country-thumb\"><img src=\"".concat(flags.svg, "\" width=\"100px\">\n        <p class=\"country-name\">").concat(name.official, "<p></div>\n        <p><span class=\"bold-text\">Capital:</span> ").concat(capital, "</p>\n        <p><span class=\"bold-text\">Population:</span> ").concat(population, "</p>\n        <p><span class=\"bold-text\">Languages:</span> ").concat(Object.values(languages).join(", "), "</p>");
  }).join("");
  divEl.insertAdjacentHTML("beforeend", markup);
}
},{"./css/styles.css":"css/styles.css","./fetchCountries":"fetchCountries.js","lodash.debounce":"../node_modules/lodash.debounce/index.js","notiflix":"../node_modules/notiflix/dist/notiflix-aio-3.2.5.min.js","notiflix/build/notiflix-notify-aio":"../node_modules/notiflix/build/notiflix-notify-aio.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
